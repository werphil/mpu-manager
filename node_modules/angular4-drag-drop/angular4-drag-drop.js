import { Attribute, ChangeDetectorRef, ComponentFactoryResolver, Directive, ElementRef, EventEmitter, Host, HostListener, Inject, Injectable, InjectionToken, Input, IterableDiffers, KeyValueDiffers, LOCALE_ID, NgModule, NgModuleRef, Optional, Output, Pipe, Renderer, TemplateRef, Version, ViewContainerRef, WrappedValue, isDevMode, ɵisListLikeIterable, ɵisObservable, ɵisPromise, ɵstringify } from '@angular/core';
...
class DragDropDirectiveService {
    constructor() {
...
class DragDirective {
     ...
     */
    constructor(el, dragDropDirectiveService) {
        this.el = el;
...
class DropDirective {
    ...
    constructor(el, dragDropDirectiveService) {
        ...
        this.dragoverMouseEvent = new EventEmitter();
        this.highlighted = false;
    }
    /**
     * @return {?}
...
export { DragDropDirectiveModule, DragDirective as ɵa, DragDropDirectiveService as ɵb, DropDirective as ɵc };
//# sourceMappingURL=angular4-drag-drop.js.map
