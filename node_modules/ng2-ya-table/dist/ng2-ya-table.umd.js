(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('ngx-bootstrap'), require('@angular/platform-browser'), require('rxjs/Subject'), require('rxjs/add/operator/debounceTime'), require('rxjs/BehaviorSubject'), require('rxjs/Observable'), require('rxjs/add/observable/of'), require('rxjs/Rx')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'ngx-bootstrap', '@angular/platform-browser', 'rxjs/Subject', 'rxjs/add/operator/debounceTime', 'rxjs/BehaviorSubject', 'rxjs/Observable', 'rxjs/add/observable/of', 'rxjs/Rx'], factory) :
	(factory((global['ng2-ya-table'] = global['ng2-ya-table'] || {}),global._angular_core,global._angular_common,global._angular_forms,global.ngxBootstrap,global._angular_platformBrowser,global.rxjs_Subject,null,global.rxjs_BehaviorSubject,global.rxjs_Observable));
}(this, (function (exports,_angular_core,_angular_common,_angular_forms,ngxBootstrap,_angular_platformBrowser,rxjs_Subject,rxjs_add_operator_debounceTime,rxjs_BehaviorSubject,rxjs_Observable) { 'use strict';
...
var Ng2YaTableService = (function () {
    function Ng2YaTableService() {
        this.stateChangedSource = new rxjs_BehaviorSubject.BehaviorSubject(this);
...
var Ng2YaTableComponent = (function () {
    ...
    function Ng2YaTableComponent(sanitizer, state) {
        ...
        this.state = state;
        this.fullTextFilterValueChanged = new rxjs_Subject.Subject();
...
Ng2YaTableComponent.propDecorators = {
    ...
    'paging': [{ type: _angular_core.Input },],
};
...
Ng2YaTableSortingDirective.decorators = [
    { type: _angular_core.Directive, args: [{ selector: '[ngTableSorting]' },] },
];
/**
 * @nocollapse
 */
...
Ng2YaTableSortingDirective.propDecorators = {
    'column': [{ type: _angular_core.Input, args: ['ngTableSorting',] },],
    'onToggleSort': [{ type: _angular_core.HostListener, args: ['click', ['$event'],] },],
    'onDisableMouseDown': [{ type: _angular_core.HostListener, args: ['mousedown', ['$event'],] },],
};
...
var Ng2YaTableFilteringDefaultComponent = (function () {
    ...
    function Ng2YaTableFilteringDefaultComponent(state) {
        var _this = this;
        this.state = state;
        this.filterValueChanged = new rxjs_Subject.Subject();
...
exports.Ng2YaTableModule = Ng2YaTableModule;
